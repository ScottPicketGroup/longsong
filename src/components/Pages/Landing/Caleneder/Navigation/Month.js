...
import { MenuMonthsContainer, MonthItem, MonthsContainer } from "../Calender.css"

import useMonthsInfo from "../../../../hooks/monthInfo"
import useScrollPosition from "../../../../hooks/ScrollPosition"

const Month = ({ currentMonth, nextMonth, handlePreviousMonthChange, handleNextMonthChange, menu }) => {
      ...
      return (
        ...
        <MenuMonthsContainer cols="2" scrollPosition={scrollPosition}>
          <MonthItem onClick={handlePreviousMonthChange}>
            ...
            {scrollPosition <= 530 &&<Month1 >{thisMonthInfo[1]}</Month1>}
          </MonthItem>
          <MonthItem onClick={handleNextMonthChange}>
            <Month2>{nextMonthInfo[0]}</Month2>
            {scrollPosition <= 530 &&<Month1 >{nextMonthInfo[1]}</Month1>}
          </MonthItem>
        </MenuMonthsContainer>
