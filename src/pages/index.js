...
const IndexPage = ({ data }) => {
  const { heroImage, landingPageSections } = data.contentfulLandingPageContent
...
export const landingPageData = graphql`
  query landing {
    contentfulLandingPageContent(
      id: { eq: "4a312602-defe-550a-b9b5-2393ed6dd3ee" }
    ) {
      id
      heroImage {
    ...
    contentfulFooterDetails(
      id: { eq: "1077f512-6ba3-5f1c-9549-9f6893907c41" }
    ) {
      openingTimes {
        raw
      }
